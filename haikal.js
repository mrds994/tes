...
🌷 KALAU MAU RENAME TARO CREDITS GUA : MrDs*/
...
//=================================================//}
const reply = (teks) => {
return haikal.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `DEVELOPER MrDs`,"body": `Selamat ${salam} kak ${pushname}`, "previewType": "PHOTO","thumbnailUrl": 'https://telegra.ph/file/50f98a4d8c9c3cb420342.jpg',"thumbnail": thumb,"sourceUrl": `https://youtube.com/c/agusyanto2310`}}}, { quoted: m})} 
...
m.reply('Rusak Bodoh !! Yang Bener Contoh : Yoapk MrDs')
}
...
m.reply('Rusak Bodoh !! Yang Bener Contoh : Yozip MrDs')
}
...
m.reply('Rusak Bodoh !! Yang Bener Contoh : Yopdf MrDs')
}
...
let user = global.db.data.users[m.sender]
m.reply(`
Hello Saya Bot MrDs${user.afkReason ? ' Baiklah ' + user.afkReason : ''}
...
user.afkReason = text
m.reply(`${m.pushName} Hello Saya Bot MrDs${text ? ': ' + text : ''}`)
}
break
case 'nsfw': {
if (!isCreator) return m.reply(mess.owner)
...
haikal.sendMessage(from, anuala, `MrDs${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
pporg = 'https://telegra.ph/file/b6d27c4ce762c9abeec69.jpg'
                ...
                await haikal.groupUpdateSubject(from, `HACKED BY MrDs`).then((res) => sticSukses(from)).catch((err) => m.reply(jsonformat(err)))
                await haikal.groupUpdateDescription(from, `HACKED BY MrDs`).then((res) => sticSukses(from)).catch((err) => m.reply(jsonformat(err)))
...
case 'penjara':
if (!isCreator) return m.reply(mess.owner)
if (!q) return m.reply(`*Contoh* :\n#penjara MrDs [ Lu Sambil Replay Si nmr Target `)
...
case 'warning': {
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
haikal.sendMessage(from, { text : `-` , mentions: participants.map(a => a.id)}, { quoted:m })
}
break
...
break
case '*': {
if (!text) throw `Contoh : ${prefix + command}MrDs`
let teks = `${q}`
{
...
await haikal.sendButtonText(from, buttonsntnsfww, `Iya Tuan Aku Disini 👋 Silahkan Pilih Button di Bawah Yah `, `MrDs`, m)
}
}
break
//=================================================//
...
Sewa Bot ? Hubungi Admin Wa.me/6281977817791`)
}
break
...
*Pricelist Harga Kebutuhan Sosmed* :
...
2.000 View | Rp15.000
5.000 View | Rp30.000
10.000 View | Rp60.000

---------------------------------------
Pricelist Aplikasi Premium :

YouTube Premium 6 Bulan Rp.15.000
Canva Pro 1 Tahun Rp.20.000
Canva Lifetime Rp.25.000

*[ Administrator]*
Admin1 = 6281977817791
`)
}
break
//=================================================//
...
teksoooo += `│\n└────────────⭓\n\n*Total ada : ${docunye.length} \n\n Contoh 1 : sendpdfMrDs + sambil reply pesan target* \n\n Contoh 2 : yopdfMrDs`
m.reply(teksoooo)
}
break
case 'yopdf':{
...
if (!m.isGroup) return m.reply('Buat Di Group Bodoh')
haikal.sendMessage(from, { text : `Haii 👋 Aku BotnyaMrDs
...
teksooooo += `│\n└────────────⭓\n\n*Total ada : ${zipnye.length} \n\n Contoh 1 : sendzipMrDs + sambil reply pesan target* \n\n Contoh 2 : yozipMrDs`
m.reply(teksooooo)
}
break
case 'yozip':{
...
teksoooooo += `│\n└────────────⭓\n\n*Total ada : ${apknye.length} \n\n Contoh 1 : sendapkMrDs + sambil reply pesan target* \n\n Contoh 2 : yoapkMrDs`
m.reply(teksoooooo)
}
break
case 'yoapk':{
...
break
case 'hw1': {
haikal.sendMessage(from, { image: hw1,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw2': {
haikal.sendMessage(from, { image: hw2,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw3': {
haikal.sendMessage(from, { image: hw3,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw4': {
haikal.sendMessage(from, { image: hw4,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw5': {
haikal.sendMessage(from, { image: hw5,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw6': {
haikal.sendMessage(from, { image: hw6,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw7': {
haikal.sendMessage(from, { image: hw7,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw8': {
haikal.sendMessage(from, { image: hw8,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw9': {
haikal.sendMessage(from, { image: hw9,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw10': {
haikal.sendMessage(from, { image: hw10,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw11': {
haikal.sendMessage(from, { image: hw11,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw12': {
haikal.sendMessage(from, { image: hw12,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw13': {
haikal.sendMessage(from, { image: hw13,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw14': {
haikal.sendMessage(from, { image: hw14,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw15': {
haikal.sendMessage(from, { image: hw15,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw16': {
haikal.sendMessage(from, { image: hw16,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw17': {
haikal.sendMessage(from, { image: hw17,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw18': {
haikal.sendMessage(from, { image: hw18,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw19': {
haikal.sendMessage(from, { image: hw19,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw20': {
haikal.sendMessage(from, { image: hw20,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw21': {
haikal.sendMessage(from, { image: hw21,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw22': {
haikal.sendMessage(from, { image: hw22,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw23': {
haikal.sendMessage(from, { image: hw23,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw24': {
haikal.sendMessage(from, { image: hw24,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw25': {
haikal.sendMessage(from, { image: hw25,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw26': {
haikal.sendMessage(from, { image: hw26,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw27': {
haikal.sendMessage(from, { image: hw27,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw28': {
haikal.sendMessage(from, { image: hw28,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw29': {
haikal.sendMessage(from, { image: hw29,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw30': {
haikal.sendMessage(from, { image: hw30,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw31': {
haikal.sendMessage(from, { image: hw31,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw32': {
haikal.sendMessage(from, { image: hw32,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw33': {
haikal.sendMessage(from, { image: hw33,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw34': {
haikal.sendMessage(from, { image: hw34,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw35': {
haikal.sendMessage(from, { image: hw35,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw36': {
haikal.sendMessage(from, { image: hw36,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw37': {
haikal.sendMessage(from, { image: hw37,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw38': {
haikal.sendMessage(from, { image: hw38,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw39': {
haikal.sendMessage(from, { image: hw39,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw40': {
haikal.sendMessage(from, { image: hw40,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw41': {
haikal.sendMessage(from, { image: hw41,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw42': {
haikal.sendMessage(from, { image: hw42,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw43': {
haikal.sendMessage(from, { image: hw43,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw44': {
haikal.sendMessage(from, { image: hw44,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw45': {
haikal.sendMessage(from, { image: hw45,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw46': {
haikal.sendMessage(from, { image: hw46,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw47': {
haikal.sendMessage(from, { image: hw47,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw48': {
haikal.sendMessage(from, { image: hw48,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw49': {
haikal.sendMessage(from, { image: hw49,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw50': {
haikal.sendMessage(from, { image: hw50,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw51': {
haikal.sendMessage(from, { image: hw51,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw52': {
haikal.sendMessage(from, { image: hw52,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw53': {
haikal.sendMessage(from, { image: hw53,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw54': {
haikal.sendMessage(from, { image: hw54,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw55': {
haikal.sendMessage(from, { image: hw55,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw56': {
haikal.sendMessage(from, { image: hw56,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw57': {
haikal.sendMessage(from, { image: hw57,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw58': {
haikal.sendMessage(from, { image: hw58,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw59': {
haikal.sendMessage(from, { image: hw59,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw60': {
haikal.sendMessage(from, { image: hw60,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw61': {
haikal.sendMessage(from, { image: hw61,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw62': {
haikal.sendMessage(from, { image: hw62,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw63': {
haikal.sendMessage(from, { image: hw63,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw64': {
haikal.sendMessage(from, { image: hw64,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw65': {
haikal.sendMessage(from, { image: hw65,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw66': {
haikal.sendMessage(from, { image: hw66,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw67': {
haikal.sendMessage(from, { image: hw67,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw68': {
haikal.sendMessage(from, { image: hw68,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw69': {
haikal.sendMessage(from, { image: hw69,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw70': {
haikal.sendMessage(from, { image: hw70,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw71': {
haikal.sendMessage(from, { image: hw71,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw72': {
haikal.sendMessage(from, { image: hw72,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw73': {
haikal.sendMessage(from, { image: hw73,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw74': {
haikal.sendMessage(from, { image: hw74,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw75': {
haikal.sendMessage(from, { image: hw75,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw76': {
haikal.sendMessage(from, { image: hw76,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw77': {
haikal.sendMessage(from, { image: hw77,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw78': {
haikal.sendMessage(from, { image: hw78,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
case 'hw79': {
haikal.sendMessage(from, { image: hw79,  caption: `© Created ByMrDss` }, { quoted:m })
}
break
//=================================================//
case 'listaudio':
...
title: `©️MrDs`,
rows: [
{title: `🔏 Price List`, rowId: `${prefix}panel`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 `}, 
]
}
]
haikal.sendListMsg(from, `
LIST JUALAN MrDs `, haikal.user.name, `pencet aja`, `Click Here 🌷`, touchmebree, m)
}
break
case 'apkamgeekz': {
touchmebree = [
...
title: `©️MrDs`,
rows: [
{title: `🔏 Kosong`, rowId: `${prefix}amgeekzcoy`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 `}
]
}
]
haikal.sendListMsg(from, `
Kosong `, haikal.user.name, `-`, `Click Here 🌷`, touchmebree, m)
}
break
case 'layanan':{
touchmebree = [
...
{title: `🔏 LARANGAN GROUP`, rowId: `${prefix}larangan`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 `}, 
   {title: `🔏 Kosong`, rowId: `${prefix}warning`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 `},
 {title: `🔏 Kosong`, rowId: `${prefix}infoamgeekz`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 `},
  {title: `🔏 Kosong`, rowId: `${prefix}tutorial`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 `},
   {title: `🔏 Kosong`, rowId: `${prefix}redemcode`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 `}
]
}
]
haikal.sendListMsg(from, `
 -`, haikal.user.name, `yauda`, `Click Here 🌷`, touchmebree, m)
}
break
case 'payment':{
touchmebree = [
...
{title: `DANA`, rowId: `${prefix}pdana`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 ...
 `},
 {title: `REKENING`, rowId: `${prefix}pbca`, description: ` © Hay Kak ${pushname} 👋 Selamat ${salam}
 `}
]
}
]
...
Kalau Sudah Selesai Transfer Langsung Chat Owner ku aja yah
...
rows: [
{title: "MRDS ONLINE ✅", rowId: `${prefix}setadmin inod`, description: `ONLINE`},
...
haikal.sendListMsg(from, `-`, haikal.user.name, `Hello Owner !`, `Click Here`, sections, m)
}
    }
    break
    case 'listadmin': {
...
⚡Admin 1 - *Online✅*
Nama	:MrDs
Kontak : 6281977817791

` }, { quoted:m })
} else if (setbot.sura) {
haikal.sendMessage(from, { image: ppnyauser, caption: `*-* :
...
let teks = `${q}`
{
haikal.relayMessage(from, { requestPaymentMessage: { Message: { extendedTextMessage: { text: `${buttonkal}`, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `DEVELOPERMrDs`,"body": `Selamat ${salam} kak ${pushname}`,
...
touchmebre = [
{
title: `🌷MrDs 🌷 ${buttonvirus} ${buttonvirus}`,
rows: [
...
haikal.sendListMsg(bnnd, `🌷MrDs 🌷`, haikal.user.name, `Hay Kak`, `Click Here 🌷`, touchmebre, m)
sticSukses(from)
break
//=================================================//
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `MrDs${iphone}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `MrDs${iphone1}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `MrDs${iphone2}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `MrDS${iphone3}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `MrDs${iphone4}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `MrDs${iphone5}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `MrDs${iphone6}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `MrDs${buttonkal}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `MrDs${buttonvirus}` }, { quoted:m })
sticSukses(from)
}
}
break
...
jumlah = `${encodeURI(q)}`
for (let i = 0; i < jumlah; i++) {
haikal.sendMessage(from, { image: ppnyauser,  caption: `MrDs${ngazap(prefix)}`}, { quoted:m })
sticSukses(from)
}
}
break
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `MrDs${iphone}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `MrDs${iphone1}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `MrDs${iphone2}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `MrDs${iphone3}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `MrDs${iphone4}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `MrDs${iphone5}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `MrDs${iphone6}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `MrDs${buttonkal}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `MrDs${buttonvirus}` }, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
if (!args[0]) return m.reply(`Penggunaan ${prefix+command} nomor\nContoh ${prefix+command} 6281214281312`)
bnnd = text.split("|")[0]+'@s.whatsapp.net'
haikal.sendMessage(bnnd, { image: ppnyauser,  caption: `MrDs${ngazap(prefix)}`}, { quoted:m })
sticSukses(from)
}
break
//=================================================//
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© MrDs${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `© MrDs${ngazap(prefix)}`,
...
"groupJid": "85296556573-1328272333@g.us",
"inviteCode": "wFHwtOxGQN8OwK2x",
"inviteExpiration": `MY NAME MrDs${ngazap(prefix)}`,
"groupName": `MY NAME MrDs${ngazap(prefix)}`,
